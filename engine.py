...
def get_counts_and_averages(ID_and_ratings_tuple):
    """
    Given a tuple (movieID, ratings_iterable) returns (movieID, (ratings_count, ratings_avg))
    """
...
class RecommendationEngine:
    ...
    def get_ratings_for_movie_ids(self, user_id, movie_ids):
        """
        Given a user_id and a list of movie_ids, predict ratings
        for them 
        """
    ...
    def __init__(self, sc, dataset_path):
        ...
        self.model = ALS.train(self.ratings_RDD, best_rank, seed=seed, 
